...
class CounterfactualValidator:
    ...
    def generate_counterfactual(
        ...
        modifiable_features: Optional[List[int]] = None,
    ) -> Optional[Dict]:
        """
        ...
        for iteration in range(self.max_iterations):
            ...
            is_valid, violations = self._check_constraints(candidate, target_diagnosis)
                ...
                if distance < best_distance:
                    ...
                    best_counterfactual = {
                        ...
                        'changes': self._identify_changes(
                            patient, candidate, feature_names
                        ),
    ...
    def generate_counterfactuals(
        ...
        for i in range(n_counterfactuals):
            ...
            cf = self.generate_counterfactual(
                patient, target_diagnosis, feature_names=feature_names
            )
    ...
    def _perturb_patient(
        self, patient: np.ndarray, modifiable_features: List[int]
    ) -> np.ndarray:
        """
    ...
    def _check_constraints(
        self, patient: np.ndarray, target_diagnosis: str
    ) -> Tuple[bool, List[str]]:
        """
    ...
    def validate_plausibility(
        ...
        is_valid, violations = self._check_constraints(counterfactual, 'unknown')
    ...
    def compute_actionable_insights(
        ...
        for target_diag in possible_diagnoses:
            ...
            cf = self.generate_counterfactual(patient, target_diag, feature_names)
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"CounterfactualValidator(max_iter={self.max_iterations}, "
...
if __name__ == '__main__':
    ...
    for diagnosis in diagnoses:
        ...
        for i, cf in enumerate(counterfactuals, 1):
            ...
            for feat, change in list(cf['changes'].items())[:5]:  # Show top 5 changes
                logger.info(
