...
class NMFExtractor:
    ...
    def fit(self, archetype_matrix: np.ndarray) -> "NMFExtractor":
        ...
        self.model = NMF(
            ...
            init='nndsvda',  # Stable non-negative SVD initialization
    ...
    def fit_transform(
        self, archetype_matrix: np.ndarray
    ...
    def interpret_components(self, feature_names: list = None) -> Dict:
        ...
        for i in range(self.n_components):
            ...
            if feature_names:
                top_features = [
                    (feature_names[idx], component_weights[idx]) for idx in top_indices
                ]
            else:
                top_features = [
                    (f"feature_{idx}", component_weights[idx]) for idx in top_indices
                ]
