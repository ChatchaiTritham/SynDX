...
class SynDXProfiler:
    ...
    def __init__(self, output_dir: str = 'outputs/profiling', enabled: bool = True):
        """
        Initialize profiler.
            ...
            self.phase_metrics[phase_name].update(
                {
                    ...
                    'memory_delta_mb': end_memory
                    - self.phase_metrics[phase_name]['start_memory_mb'],
                }
            )
    ...
    def generate_report(self, output_file: str = 'profiling_report.txt') -> str:
        """
            ...
            for phase_name, metrics in sorted(self.phase_metrics.items()):
                ...
                if 'subphases' in metrics and metrics['subphases']:
                    ...
                    for subphase, sub_metrics in metrics['subphases'].items():
                        ...
                        report_lines.append(f"    - {subphase:30s} {sub_time:.3f}s")
        else:
